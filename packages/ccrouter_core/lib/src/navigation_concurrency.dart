...
/// backends and is empty until an adapter supplies one. Requests carrying
/// process-local Extra data never create this key because arbitrary objects do
/// not have a stable, type-safe equality contract.
